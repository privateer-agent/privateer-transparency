...
// Auth middleware re-exported from the central middleware module.
// Routes and other controllers should import from here for backward compat.
const { authenticate, lightAuthenticate, authenticateAdmin } = require('../middleware/auth');
